...
PiecewiseInterval(d::Vector)=PiecewiseInterval{eltype(d)}(d)
PiecewiseInterval{T<:Number}(d::AbstractVector{Tuple{T,T}})=PiecewiseInterval(map(Vec,d))
PiecewiseInterval(d...)=PiecewiseInterval([d...])
